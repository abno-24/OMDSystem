<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ngoRegister.aspx.cs" Inherits="OMDSystem.ngoRegister" %>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img width="150px" src="imgs/ngoRegister.png" />
                                </center>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server"
                                        placeholder="NGO Name"></asp:TextBox><br />
                                </div>
                            </div>
